...
object ErrorMessages {
  ...
  val UserAlreadyLinkedToCustomer = "OBP-30071: The User is already linked to a Customer"
  val CustomerAlreadyLinkedToUser = "OBP-30072: The Customer is already linked to an User"
